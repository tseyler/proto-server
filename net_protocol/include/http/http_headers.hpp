...
namespace proto_http
{
	...
	http_headers_map headers(void) const { return headers_; }
	...
	http_headers_map headers_map(void) { return headers_; }
	http_headers_map& get_headers_map(void) { return headers_; }
	size_t size(void) { return headers_.size(); }
	void clear(void) { headers_.clear(); }
