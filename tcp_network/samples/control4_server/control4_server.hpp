...
#ifndef CONTROL4_SERVER_HPP_
#define CONTROL4_SERVER_HPP_
...
namespace control4
{
    ...
    class control4_server : public tcp_net::tcp_server,
			public tcp_net::tcp_server_pipe
    {
    public:

	control4_server(boost::asio::io_service& io_service, short port);
	...
	virtual void handle_accept(control4_session* session,
