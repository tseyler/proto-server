...
// useragent_signaling::useragent_signaling(const std::string& local_address) :	local_address_(local_address)//,
// 																				//user_agent_(new UserAgent(0, false,"t0talc0ntr0l4!"))
// {
// 	setup_local_SDP();
// }
...
// 						//bool multicast = connection.is_multicast_address();
...
// {
// 	if (user_agent_ && !user_agent_->IsRunning())
// 		user_agent_->Start();
// }
...
// void 
// useragent_signaling::restart_useragent(int port, bool disable_udp, const std::string& profile_aor, const std::string& passwd)
// {
// 	// destroyed by resert
// 	user_agent_.reset();
