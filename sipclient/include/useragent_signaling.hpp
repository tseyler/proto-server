...
namespace useragent_console_app
{
/*
	...
	public:
		...
		// answer/reject call
		void execute_offer_useragent(const std::string& call_id, bool accept_call = true, int status_code = 200);
		// hangup the call
		...
		void restart_useragent(int port, bool bDisableUDP, const std::string& profile_aor, const std::string& passwd);
